...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    let scope = b"123e4567-e89b-12d3-a456-426614174000".to_vec();
    let presentation_header = scope.clone();

    let attestation_type = b"android_strongbox".to_vec();
    let device_type = b"android".to_vec();
